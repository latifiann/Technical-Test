...
import transactionService from "../services/transactionService"; // Adjust the import path as necessary
...
const TransactionPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setNewTransaction({ customer_id: "", product_id: "" });
    // Re-fetch transactions after creating a new one
    fetchTransactions();
  };
