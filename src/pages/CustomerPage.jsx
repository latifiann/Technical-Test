...
import customerService from "../services/customerService"; // Adjust the import path as necessary
    ...
    <>
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <h2 className="text-lg font-bold mb-4">Customer Internet Data List</h2>
